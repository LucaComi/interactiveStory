...
enum Story: String {    // aggiungengo String creo dei rawValue che posso andare ad utilzzare per chiamare le immagini che ho bisogno
...
struct Adventure {
    ...
    static var story: Page {
        ...
        cave.addChoice("Contine towards faint light", story: .Droid)
